...
function my_acf_init_block_types() {
    ...
    if( function_exists('acf_register_block_type') ) {
        ...
        acf_register_block_type(array(
            'name'              => 'Airfleet',
            'title'             => __('Airfleet'),
            'description'       => __('A custom airfleet block.'),
            'render_template'   => 'template-parts/blocks/airfleet/airfleet.php',
            'category'          => 'formatting',
            'icon'              => 'admin-comments',
            'keywords'          => array( 'airfleet', 'quote' ),
			'enqueue_assets' 	=> function(){
				wp_enqueue_script( 'slick', 'https://code.jquery.com/jquery-3.5.1.min.js', array('jquery'), '1.8.1', true );
				wp_enqueue_style( 'airfleet-block', get_template_directory_uri() . '/template-parts/blocks/airfleet/block.css',);
				wp_enqueue_script( 'airfleet-block', get_template_directory_uri() . '/template-parts/blocks/slider/block.js', array(), '1.0.0', true );
...
add_action( 'wp_enqueue_scripts', 'wp_enqueue_style', 'my_new_scripts', );